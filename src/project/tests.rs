...
static PRODUCT_CATALOG: &'static  str =
r#"
cataloge:
...
static PRODUCT_TEST_SUM_UP1: &'static  str =
r#"
products:
  *kaffee: { amount: 20 }
...
static PRODUCT_TEST_SUM_UP2: &'static  str =
r#"
products:
...
static PRODUCT_TEST_SUM_UP3: &'static  str =
r#"
products:
...
static PRODUCT_TEST_SUM_UP4: &'static  str =
r#"
...
#[test] fn sum_up_products2(){ compare_sum(PRODUCT_TEST_SUM_UP2, 60_70); }
#[test] fn sum_up_products3(){ compare_sum(PRODUCT_TEST_SUM_UP3, 65_28); }
